    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                @endif
                <form action="{{ route('leave.update', ['leave' => $leave->id]) }}" method="POST" id="item-part-form">
                    @csrf
                            ...
                            <div class="col-xl-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" name="user_id" id="user_id">
                                                ...
                                                @foreach ($users as $item)
                                                    <option value="{{ $item->id }}" @if ($leave->user_id == $item->id) selected @endif>
                                                        {{ $item->name }}
                                                    </option>
                                                @endforeach
                                        </select>
                                ...
                                <div class="row mb-1">
                                    <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="dd-mm-yyyy" id="leave_from" name="leave_from" value="{{ $leave->leave_from }}">
                                    </div>
                                    <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        <label for="input-Date" class="col-form-label">Leave Till</label> <i class="text-danger">*</i>
                                        <input type="text" class="form-control" placeholder="dd-mm-yyyy" id="leave_till" name="leave_till" value="{{ $leave->leave_till }}">
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <label for="description" class="col-form-label">Days</label> 
                                        <input type="text" class="form-control" id="total_leave" name="total_leave" value="{{ $leave->total_leave }}">
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <select class="form-control" name="leave_type" id="leave_type">
                                                ...
                                                <option value="Paid" @if ($leave->leave_type == 'Paid') selected @endif>Paid</option>
                                    ...
                                    <div class="form-group col-xl-3 col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <select class="form-control" name="leave_duration" id="leave_duration">
                                                <option value="Full" @if ($leave->leave_duration == 'Full') selected @endif>Full Day</option>
                                                <option value="Half" @if ($leave->leave_duration == 'Half') selected @endif>Half Day</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <textarea class="form-control" placeholder="Leave Reason here..." id="reason" name="reason">{{ $leave->reason }}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" name="is_approved" id="is_approved">
                                                <option value=1 @if ($leave->is_approved == 1) selected @endif>Approved</option>
                                                <option value=0 @if ($leave->is_approved == 0) selected @endif>Not Approved</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-1">
