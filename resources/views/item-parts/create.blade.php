    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                @endif
                <form action="{{ route('item-parts.store') }}" method="POST" id="item-part-form">
                    @csrf
                    <div class="card-body gy-4">
                        <div class=" row mb-2">
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                ...
                                <select name="product_group_id" id="product_group_id" class="form-control">
                                    ...
                                    <option value="{{ $product_group->id }}" {{ old('
                                        product_group_id')==$product_group->id ? 'selected' : '' }}>
                        ...
                        <div class="row mb-2">
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                <label for="inputName" class="col-form-label">Hsn Code</label> <i
                                    class="text-danger">*</i>
