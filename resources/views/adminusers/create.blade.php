        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    @endif --}}
                    <form action="{{ route('adminusers.store') }}" method="POST" id="party-form" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body gy-4">
                            ...
                            <div class="form-group row mb-2">
                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label for="inputName" class="col-form-label">Mobile No</label><i
                                        class="text-danger">*</i>
                                    <input type="phone_no" id="inputPhone" class="form-control" name="phone_no" value="{{ old('phone_no') }}">
                                    @error('phone_no')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <label for="main_machine_type" class="col-form-label">Machine Type</label>
                                        <select class="form-control" id="main_machine_type" name="main_machine_type[]" multiple>
                                            ...
                                            <option value="{{ $item->id }}">{{ $item->machine_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>    
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label for="input-textarea" class="col-form-label">Shift</label> <i class="text-danger">*</i>
                                        <select class="form-control" id="shift_id" name="shift_id">
                                            <option value="">Choose a Shift</option>
                                            @foreach (App\Models\Shift::where('is_active', 1)->get() as $item)
                                                <option value="{{ $item->id }}">{{ $item->title }} - {{ $item->shift_start }} - {{$item->shift_end }}</option>
                                            @endforeach
                                        </select>
                                        @error('shift_id')
                                        <span class="text-danger">{{ $message }}</span>
