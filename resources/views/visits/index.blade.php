                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="justify-content-end">
                            ...
                            <a href="{{ route('visits.create', ['main_machine_type' => $main_machine_type, 'machinesale' => $machinesale]) }}" class="btn btn-md btn-primary "> Create </a>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#sales-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('visits.index', ['main_machine_type' => $main_machine_type, 'machinesale' => $machinesale]) }}",
                    type: 'GET',
                    data: function(d) {
