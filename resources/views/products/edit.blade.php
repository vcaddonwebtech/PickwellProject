        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    @endif
                    <form action="{{ route('products.update', ['product' => $product->id]) }}" method="POST" id="service-type-form">
                        @csrf
                        ...
                        <div class="card-body gy-4">  
                            ...
                            <div class="row mb-2">
                                <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                    <label for="product_group_id" class="form-label">Product Group Name</label> <i
                                        class="text-danger">*</i>
                                    <select class="form-select" id="product_group_id" name="product_group_id" required> 
                                       <option selected value="{{ $main_machine_type }}">{{ $main_machine_name }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class=" row mb-2">
