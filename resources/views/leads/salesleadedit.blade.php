            ...
            <div class="">
                <nav>
                    <ol class="breadcrumb mb-1 mb-md-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('work-update-list') }}">Work List</a></li>
                    ...
                    <div class="card-body gy-4">
                        <div class="row mb-2">
                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" placeholder="yyyy-mm-dd" id="date" name="date" value="{{ $lead->date ?? old('date') }}" required>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <label for="inputBill" class="col-form-label">Time</label>
                                <input type="time" name="time" value="{{ $lead->time ?? old('time') }}" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" id="mobile_no" class="form-control" name="mobile_no" value="{{ $lead->mobile_no ?? old('mobile_no') }}" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <label for="inputaddress" class="col-form-label">Party Address</label> 
                                <input type="text" id="address" class="form-control" name="address" value="{{ $lead->address ?? old('address') }}" required>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <label for="inputlocation_Address" class="col-form-label">Party Area</label> <i class="text-danger">*</i>
                                <input type="text" id="location_Address" class="form-control" name="location_Address" value="{{ $lead->location_Address ?? old('location_Address') }}" required>
                            </div>
                        </div>
                        <div class="row mb-2" >
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                ...
                                <select name="status_id" id="status_id" class="form-control">
                                    <option value="4" {{ $lead->status_id == '4' ? 'selected' : ''}}> Pending</option>
                                    <option value="5" {{ $lead->status_id == '5' ? 'selected' : ''}}> In Progress</option>
                                    <option value="7" {{ $lead->status_id == '7' ? 'selected' : ''}}> Closed</option>
                                    ...
                                    <select class="form-control" name="sale_assign_user_id" id="sale_assign_user_id">
                                        <option value="">Choose a Sales Person</option>
                                            @foreach ($salespersons as $item)
                                                ...
                                                @if ($lead->sale_assign_user_id == $item->id) selected @endif>
                        ...
                        <div class="row mb-1">
                                        <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <textarea type="text" id="remarks" class="form-control" name="remarks" aria-describedby="nameHelpInline"> {{ $lead->latestSalesPersonTask->comment_first }}</textarea>
                                        </div>
                        ...
                        <div class="row align-items-center text-center">
                            ...
                            <div class="col-md-4 mb-3">
                                @if($lead->image)
                                    <img src="{{ asset('complaint/images/' . $lead->image) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                @if($lead->audio)
                                    <audio controls style="width:100%;">
                                        <source src="{{ asset('complaint/audios/' . $lead->audio) }}" type="audio/mp4">
                            ...
                            <div class="col-md-4 mb-3">
                                @if($lead->video)
                                    <video width="100%" height="150" controls style="border-radius:8px;">
                                        <source src="{{ asset('complaint/videos/' . $lead->video) }}" type="video/mp4">
