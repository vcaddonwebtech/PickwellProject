    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                @endif
                <form action="{{ route('contact_persons.update', ['contact_person' => $contact_person->id]) }}"
                    method="POST" id="service-type-form">
                    @csrf
                        ...
                        <div class=" row mb-2">
                            <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                ...
                                <input type="text" id="inputName" class="form-control" name="name"
                                    value="{{ $contact_person->name ?? old('name') }}" required>
                            </div>
                        </div>
                        <div class=" row mb-2">
                            <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                ...
                                <input type="text" id="inputName" class="form-control" name="phone_no"
                                    value="{{ $contact_person->phone_no ?? old('phone_no') }}" required>
                            </div>
                        </div>
                        <div class=" row mb-2">
