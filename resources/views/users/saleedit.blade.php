                ...
                <div class="">
                    <nav>
                        <ol class="breadcrumb mb-1 mb-md-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('machineservicedata', ['main_machine_type' => $user_main_machine_type]) }}">{{ $main_machine_name }}</a></li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    @endif --}}
                    <form action="{{ route('users.update', ['user' => $user]) }}" method="POST" id="party-form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body gy-4">
                            ...
                            <div class="form-group row mb-2"> 
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control" id="main_machine_type" name="main_machine_type[]" multiple>
                                        <option value="1" @if (isset($main_machine_type) && in_array(1, $main_machine_type['main_machine_type'])) selected @endif>TEXTALK</option>
                                        <option value="2" @if (isset($main_machine_type) && in_array(2, $main_machine_type['main_machine_type'])) selected @endif>ZETA</option>
                                        <option value="3" @if (isset($main_machine_type) && in_array(3, $main_machine_type['main_machine_type'])) selected @endif>RARE</option>
                                        <option value="4" @if (isset($main_machine_type) && in_array(4, $main_machine_type['main_machine_type'])) selected @endif>BEADS</option>
                                        <option value="5" @if (isset($main_machine_type) && in_array(5, $main_machine_type['main_machine_type'])) selected @endif>INK</option>
                                    </select>
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                            ...
                            <div class="row">
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    ...
                                    <input type="time" id="duty_start" class="form-control" name="duty_start"
                                        value="{{ $user->duty_start ?? '09:00:00' }}">
                                </div>
                                <div class="form-group col-xl-3 col-lg-3 col-md-4 col-sm-12">
                                    <label for="duty_end" class="col-form-label">Out Time</label>
                                    <input type="time" id="duty_end" class="form-control" name="duty_end"
                                        value="{{ $user->duty_end ?? '17:00:00' }}">
                                </div>
                            </div>
