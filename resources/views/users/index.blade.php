                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="justify-content-end">
                            ...
                            <a href="{{ route('users.create', ['main_machine_type' => $main_machine_type]) }}" class="btn btn-md btn-primary "> Create </a>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#user-table').DataTable({
                ...
                // ],
                ajax: {
                    url: "{{ route('users.index', ['main_machine_type' => $main_machine_type]) }}",
                    type: 'GET',
                    data: function(d) {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            // Change text color based on status
                                ...
                                let baseUrl = "{{ url('users/usersprofile/' . $main_machine_type) }}";
