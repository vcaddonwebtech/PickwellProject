                ...
                <div class="">
                    <nav>
                        <ol class="breadcrumb mb-1 mb-md-0">
							...
							<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('users.index', ['main_machine_type' => $main_machine_type]) }}">Users</a></li>
										...
										<div class="p-4">
											<div class="main-img-user profile-user">
												<img alt="" src="{{ $userDetail->profile ? asset('user_dp/' . $userDetail->profile) : '' }}"><a
													...
													href="{{route('users.edit', ['main_machine_type' => $main_machine_type, $user_id])}}"></a>
													<span class="ms-auto">
                                            </span>
											</div>
