                ...
                <div class="card-body gy-4">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-sm-12">
                            ...
                            @endif
                            <form action="{{ route('machines.store') }}" method="POST" id="machine-form">
                                @csrf
                                <div class="row mb-2">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                        ...
                                        <input type="text" id="inputName" class="form-control" name="machine_name" value="{{ old('machine_name') }}" required>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                        <label for="inputSpecifications" class="col-form-label">Specifications</label> <i class="text-danger">*</i>
                                        <input type="text" id="inputSpecifications" class="form-control" name="machine_specification" value="{{ old('machine_specification') }}" required>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="form-group col-xl-6 col-lg-6 col-md-8 col-sm-12">
                                        <label for="inputRPM" class="col-form-label">RPM</label> <i class="text-danger">*</i>
                                        <input type="text" id="inputRPM" class="form-control" name="machine_rpm" value="{{ old('machine_rpm') }}" required>
                                    </div>
                                </div>
