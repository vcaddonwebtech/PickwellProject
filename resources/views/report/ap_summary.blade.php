                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="justify-content-end">
                            <a href="{{ route('export-ap-summary', ['main_machine_type' => $main_machine_type]) }}" class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i></a>
                            ...
                            <table class="table text-nowrap table-bordered" id="ap-details">
                                <thead class="table-secondary bg-gray">
                                    <tr>
                                        ...
                                        <th>Inprogress Complaints</th>
                                        <th>Today Done Complaints</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#ap-details').DataTable({
                ...
                searchinput: false,
                ajax: {
                    url: "{{ route('ap_summary', ['main_machine_type' => $main_machine_type]) }}",
                    type: 'GET',
                    data: function(d) {
                        d.month = $('#month').val();
