                ...
                <div class="">
                    <nav>
                        <ol class="breadcrumb mb-1 mb-md-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sales Work Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        render: function(data, type, row) {
                            // Change text color based on status
                               ...
                               // let baseUrl = "{{ url('adminusers/adminusersprofile') }}";
                                let baseUrl = "{{ url('edit-work') }}";
                                return '<a href="' + baseUrl + '/'+ row.id +'" data-bs-toggle="tooltip" title="View Profile" data-bs-placement="top" data-bs-original-title="Edit Work">' + data + '</a>';
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                                ...
                                if (row.image && row.image !== '') {
                                 ...
                                 let baseUrl = "{{ asset('complaint/images') }}/";

                                    return '<img src="' + baseUrl + row.image + '" ' +
