                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="justify-content-end">
                            <a href="{{ route('export-engineer-performance') }}" class="btn btn-primary"><i
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table text-nowrap table-bordered" id="eng-performance-table">
...
@section('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#engineer_id').select2();
            var table = $('#eng-performance-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('report.engineer-performance') }}',
                    type: 'GET',
                    data: function(d) {
