                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="justify-content-end">
                            <a href="{{ route('export-ap-summary') }}" class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i></a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#ap-details').DataTable({
                ...
                searchinput: false,
                ajax: {
                    url: "{{ route('saleap_summary', ['main_machine_type' => $main_machine_type]) }}",
                    type: 'GET',
                    data: function(d) {
                        d.month = $('#month').val();
