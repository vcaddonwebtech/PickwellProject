                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="justify-content-end">
                            <a href="{{ route('generate-salaries', ['main_machine_type' => $main_machine_type]) }}" class="btn btn-primary"><i class="fa fa-file" aria-hidden="true"></i> Generate Salaries</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#sal-details').DataTable({
                ...
                searchinput: false,
                ajax: {
                    url: "{{ route('salaries', ['main_machine_type' => $main_machine_type]) }}",
                    type: 'GET',
                    data: function(d) {
                        d.month = $('#month').val();
